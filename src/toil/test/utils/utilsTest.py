...
class UtilsTest(ToilTest):
    ...
    def testAWSProvisionerUtils(self):
        ...
        try:
            ...
            try:
                AWSProvisioner.sshLeader(clusterName=clusterName, sshOptions=['-oStrictHostKeyChecking=yes'])
            except RuntimeError:
                pass
            else:
            ...
            AWSProvisioner.sshLeader(clusterName=clusterName, sshOptions=['-oStrictHostKeyChecking=no'])
