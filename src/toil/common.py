...
def _addOptions(addGroupFn, config):
    ...
    addOptionFn("--sse", dest="sse", default=False,
                help="Enables server side encryption with the AWS job store. If --sseKey is not "
                     "set, SSE (i.e. Amazon-managed encryption) will be used instead of SSE-C.")
    addOptionFn("--sseKey", dest="sseKey", default=None,
                help="Path to file containing 32 character key to be used for server-side encryption on "
                     "awsJobStore. SSE will not be used if this flag is not passed.")
